...
declare namespace Utils {
	export { calculateHorizontalFoV, calculateVerticalFoV, createPromise, disposeObject3D, downloadBlob, getBounds, getCache, getCirclePosition, getElementViewLeft, getElementViewTop, isObjectVisible };
}
